...
#ifdef CONFIG_U_MEDIA
#include "umedia_vela.h"
#endif
...
#if (defined CONFIG_GPB261) || (defined CONFIG_GPB261_PHY_CONNECTOR)
#define CONFIG_GPB261
#include "gpb261.h"
#endif
...
int star_switch_get_port_link_status(char *buffer, char **start, off_t offset, int length, int *eof, void *data);
//Jacky.Yang 26-Aug-2009, End - Add command line for control port0~3.

//june.chen, 2011-01-03
int star_switch_get_port_enable(char *buffer, char **start, off_t offset, int length, int *eof, void *data);
...
#ifdef CONFIG_GPB239M
#define PORT1_PVID			(VLAN1_GROUP_ID)
#else
