...
// ED HW reset via gpio20 to Realtek switch
#if defined (CONFIG_GPB239M) 
...
static struct proc_dir_entry *star_phy_reset_proc_entry;
//Jacky.Yang 26-Aug-2009, Begin - Add command line for control port0~3.
static struct proc_dir_entry *star_switch_port_enable_entry;
static struct proc_dir_entry *star_switch_port_disable_entry;
static struct proc_dir_entry *star_switch_port_link_status_entry;
//Jacky.Yang 26-Aug-2009, End - Add command line for control port0~3.

#define COWN_CHECK_PERIOD 100
int cown_rebooot = 0;
static int arpr  = 0; //ARP Reply sum
static int arprc = 0; //ARP Reply sum check count
static int check_cown_num = 0;
#define CHECK_PACKET_NUM 8
// -------------------------------------------------------------------------------------------
static struct timer_list cown_check_timer;
static void cown_check(void);
static void cown_check_update(unsigned long data);
void print_packet(unsigned char *data, int len);
// -------------------------------------------------------------------------------------------
static int read_phy(u8 phy_addr, u8 phy_reg, u16 volatile *read_data)
   {
      u32 status;
      int i;
...
void show_reg(void)
   {
      ...
      printk("\nEmbedded Switch\n");
      printk("---------------------------------------------------------------------\n");
      printk("0x000: PHY Control                              0x%x\n",GSW_MEM_MAP_VALUE(0x000));
      printk("0x004: Switch Configuration                     0x%x\n",GSW_MEM_MAP_VALUE(0x004));
      printk("0x008: MAC Port 0 Configuration                 0x%x\n",GSW_MEM_MAP_VALUE(0x008));
      printk("0x00C: MAC Port 1 Configuration                 0x%x\n",GSW_MEM_MAP_VALUE(0x00C));
      printk("0x010: CPU Port Configuration                   0x%x\n",GSW_MEM_MAP_VALUE(0x010));
      printk("0x014: Priority Control                         0x%x\n",GSW_MEM_MAP_VALUE(0x014));
      printk("0x018: UDP Priority                             0x%x\n",GSW_MEM_MAP_VALUE(0x018));
      printk("0x01C: IP TOS  0-7  Prioity                     0x%x\n",GSW_MEM_MAP_VALUE(0x01C));
      printk("0x020: IP TOS  8-15 Prioity                     0x%x\n",GSW_MEM_MAP_VALUE(0x020));
      printk("0x024: IP TOS 16-23 Prioity                     0x%x\n",GSW_MEM_MAP_VALUE(0x024));
      printk("0x028: IP TOS 24-31 Prioity                     0x%x\n",GSW_MEM_MAP_VALUE(0x028));
      printk("0x02C: IP TOS 32-39 Prioity                     0x%x\n",GSW_MEM_MAP_VALUE(0x02C));
      printk("0x030: IP TOS 40-47 Prioity                     0x%x\n",GSW_MEM_MAP_VALUE(0x030));
      printk("0x034: IP TOS 48-55 Prioity                     0x%x\n",GSW_MEM_MAP_VALUE(0x034));
      printk("0x038: IP TOS 56-63 Prioity                     0x%x\n",GSW_MEM_MAP_VALUE(0x038));
      printk("0x03C: Scheduling Control                       0x%x\n",GSW_MEM_MAP_VALUE(0x03c));
      printk("0x040: Rate Limit Control                       0x%x\n",GSW_MEM_MAP_VALUE(0x040));
      printk("0x044: Flow Control Global Threshold            0x%x\n",GSW_MEM_MAP_VALUE(0x044));
      printk("0x048: Flow Control Port Threshold              0x%x\n",GSW_MEM_MAP_VALUE(0x048));
      printk("0x04C: Smart Flow Control                       0x%x\n",GSW_MEM_MAP_VALUE(0x04C));
      printk("0x050: ARL Table Access Control 0               0x%x\n",GSW_MEM_MAP_VALUE(0x050));
      printk("0x054: ARL Table Access Control 1               0x%x\n",GSW_MEM_MAP_VALUE(0x054));
      printk("0x058: ARL Table Access Control 2               0x%x\n",GSW_MEM_MAP_VALUE(0x058));
      printk("0x05C: Port VID                                 0x%x\n",GSW_MEM_MAP_VALUE(0x05C));
      printk("0x060: VLAN Group ID 0-1                        0x%x\n",GSW_MEM_MAP_VALUE(0x060));
      printk("0x064: VLAN Group ID 2-3                        0x%x\n",GSW_MEM_MAP_VALUE(0x064));
      printk("0x068: VLAN Group ID 4-5                        0x%x\n",GSW_MEM_MAP_VALUE(0x068));
      printk("0x06C: VLAN Group ID 6-7                        0x%x\n",GSW_MEM_MAP_VALUE(0x06C));
      printk("0x070: VLAN Port Map                            0x%x\n",GSW_MEM_MAP_VALUE(0x070));
      printk("0x074: VLAN Tag Port Map                        0x%x\n",GSW_MEM_MAP_VALUE(0x074));
      printk("0x078: Session ID 0-1                           0x%x\n",GSW_MEM_MAP_VALUE(0x078));
      printk("0x07C: Session ID 2-3                           0x%x\n",GSW_MEM_MAP_VALUE(0x07C));
      printk("0x080: Session ID 4-5                           0x%x\n",GSW_MEM_MAP_VALUE(0x080));
      printk("0x084: Session ID 6-7                           0x%x\n",GSW_MEM_MAP_VALUE(0x084));
      printk("0x088: Interrupt Status                         0x%x\n",GSW_MEM_MAP_VALUE(0x088));
      printk("0x08C: Interrupt Mask                           0x%x\n",GSW_MEM_MAP_VALUE(0x08C));
      printk("0x090: Auto-Polling PHY Address                 0x%x\n",GSW_MEM_MAP_VALUE(0x090));
      printk("0x094: Test 0 (Clock Skew Setting)              0x%x\n",GSW_MEM_MAP_VALUE(0x094));
      printk("0x098: Test 1 (Queue Status and PHY Address )   0x%x\n",GSW_MEM_MAP_VALUE(0x098));
      printk("0x09C: Inter Switch Tag Control                 0x%x\n",GSW_MEM_MAP_VALUE(0x09C));
      printk("0x100: TS_DMA Control                           0x%x\n",GSW_MEM_MAP_VALUE(0x100));
      printk("0x104: FS_DMA Control                           0x%x\n",GSW_MEM_MAP_VALUE(0x104));
      printk("0x108: TS Descriptor Pointer                    0x%x\n",GSW_MEM_MAP_VALUE(0x108));
      printk("0x10C: FS Descriptor Pointer                    0x%x\n",GSW_MEM_MAP_VALUE(0x10C));
      printk("0x110: TS Descriptor Base Address               0x%x\n",GSW_MEM_MAP_VALUE(0x110));
      printk("0x114: FS Descriptor Base Address               0x%x\n",GSW_MEM_MAP_VALUE(0x114));
      printk("0x118: Delayed Interrupt Configuration          0x%x\n",GSW_MEM_MAP_VALUE(0x118));
      printk("0x200: HNAT Configuration                       0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x204: PIB                                      0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x208: DMAC0_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));      
      printk("0x20C: DMAC0_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x210: DMAC1_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x214: DMAC1_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x218: DMAC2_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x21C: DMAC2_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x220: DMAC3_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x224: DMAC3_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x228: RULE_FW_START_ADDR                       0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x22C: RULE_FW_END_ADDR                         0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x230: RULE_FL_START_ADDR                       0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x234: RULE_FL_END_ADDR                         0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x238: ALG_START_ADDR                           0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x23C: ALG_END_ADDR                             0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x240: SIP_BASE_ADDR                            0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x244: NAPT_BASE_ADDR                           0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x248: NAPT_PORT_ADDR                           0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x24C: ARP_BASE_ADDR                            0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x250: TCP_SNA_THRESHOLD                        0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x254: SMAC0_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x258: SMAC0_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x25C: SMAC1_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x260: SMAC1_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x264: SMAC2_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x268: SMAC2_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x26C: SMAC3_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x270: SMAC3_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x274: SMAC4_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x278: SMAC4_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x27C: SMAC5_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x280: SMAC5_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x284: SMAC6_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x288: SMAC6_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x28C: SMAC7_H                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x290: SMAC7_L                                  0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x294: MISS_LIMIT                               0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("0x298: AGING_CFG                                0x%x\n",GSW_MEM_MAP_VALUE(0x200));
      printk("\n");
      printk("RTL 8201CP\n");
      printk("---------------------------------------------------------------------\n");
      read_phy(1, 0, &phy_data);
      printk("0x00:  Basic Mode Control                       0x%x\n",phy_data);
      read_phy(1, 1, &phy_data);
      printk("0x01:  Basic Mode Status                        0x%x\n",phy_data);
      read_phy(1, 2, &phy_data);
      printk("0x02:  PHY Identifier 1                         0x%x\n",phy_data);
      read_phy(1, 3, &phy_data);
      printk("0x03:  PHY Identifier 2                         0x%x\n",phy_data);
      read_phy(1, 4, &phy_data);
      printk("0x04:  Auto-Negotiation advertisement           0x%x\n",phy_data);
      read_phy(1, 5, &phy_data);
      printk("0x05:  Auto-Negotiation Link Partner Ability    0x%x\n",phy_data);
      read_phy(1, 6, &phy_data);
      printk("0x06:  Auto-Negotiation Expansion               0x%x\n",phy_data);
      read_phy(1, 16, &phy_data);
      printk("0x16:  NWAY Setup                               0x%x\n",phy_data);
      read_phy(1, 17, &phy_data);
      printk("0x17:  Loopback,Bypass,Receiver error MASK      0x%x\n",phy_data);
      read_phy(1, 18, &phy_data);
      printk("0x18:  RX_ER Counter                            0x%x\n",phy_data);
      read_phy(1, 19, &phy_data);
      printk("0x19:  SNR Display                              0x%x\n",phy_data);
      read_phy(1, 25, &phy_data);
      printk("0x25:  TEST                                     0x%x\n",phy_data);
      printk("\n");
      return;
   }
// -------------------------------------------------------------------------------------------
void show_ring(void)
   {
      STAR_GSW_TXDESC volatile *txptr;
      STAR_GSW_RXDESC volatile *rxptr;
      ...
      for(i=0;i<STAR_GSW_MAX_TFD_NUM;i++)
         {
            txptr = txring.vir_addr + i;
            printk("txring [%02d]\n",i);
            printk("-------------------------------------------\n");
            printk("data_ptr  = 0x%x\n",txptr->data_ptr);
            printk("length    = 0x%x\n",txptr->length);  
            printk("tco       = 0x%x\n",txptr->tco);
            printk("uco       = 0x%x\n",txptr->uco);
            printk("ico       = 0x%x\n",txptr->ico);
            ...
            if(txptr->data_ptr!=0)
               {
                  printk("\n");
                  myskb = txring.skb_ptr[i];
                  print_packet(myskb->data,myskb->len);
               }
            printk("\n");
         }
      printk("\n");
...
// -------------------------------------------------------------------------------------------
static struct timer_list cown_check_timer = TIMER_INITIALIZER(cown_check_update, 0, 0);
// -------------------------------------------------------------------------------------------
static void cown_check_update(unsigned long data)
   {
      cown_check();
      if(arprc<STAR_GSW_MAX_TFD_NUM+5){mod_timer(&cown_check_timer, jiffies + COWN_CHECK_PERIOD);}
   }
// -------------------------------------------------------------------------------------------
static void cown_check(void)
   {
      int i = 0 , mycown = 0;
      STAR_GSW_TXDESC volatile *myptr;
      
      if(check_cown_num >= arprc){return;}
      
      printk("cown check:");
      for(i=0;i<STAR_GSW_MAX_TFD_NUM;i++)
         {
            myptr = txring.vir_addr + i;
            if(i%10==0){printk(" ");}
            printk("%d",myptr->cown);
            if(myptr->cown==0){mycown++;}
         }
      printk(" [%d]\n",arpr);
      check_cown_num++;
      if(mycown >= CHECK_PACKET_NUM)
         {
            if(cown_rebooot==1)
               {
                  printk("\n\nKH: emergency_restart [cown]\n\n");
                  show_reg();
                  show_ring();
                  emergency_restart();
	       }
...
// 20060922 descent end
	...
	num += sprintf(page + num, "MAC0 REG: %x (%s:%s,%s,%s,%s)\n", GSW_MAC_PORT_0_CONFIG,
			...
			(GSW_MAC_PORT_0_CONFIG&(0x3<<2))==(0x2<<2)?"1000Mbps":
		   ((GSW_MAC_PORT_0_CONFIG&(0x3<<2))==(0x1<<2)?"100Mbps":"10Mbps"),
	...
	num += sprintf(page + num, "MAC1 REG: %x (%s:%s,%s,%s,%s)\n", GSW_MAC_PORT_1_CONFIG,
			...
			(GSW_MAC_PORT_1_CONFIG&(0x3<<2))==(0x2<<2)?"1000Mbps":
			((GSW_MAC_PORT_1_CONFIG&(0x3<<2))==(0x1<<2)?"100Mbps":"10Mbps"),
...
{
	volatile union {u32 lookup_result; u8 t[4];} u;
	...
	u.t[3] = mac[2];
#else
	u.lookup_result = *(u32*)(mac+2);
#endif
	GSW_ARL_TABLE_ACCESS_CONTROL_2 = u.lookup_result;

	/* GSW_ARL_TABLE_ACCESS_CONTROL_1 =
		((vlan_gid << 5)	|
		((mac[0] & 0xFF) << 16)	|
		((mac[1] & 0xFF) << 24) );*/
	u.lookup_result = (vlan_gid << 5);
#ifdef __BIG_ENDIAN
	u.t[0] = mac[1];
	u.t[1] = mac[0];
#else
	...
	*(u16*)(u.t+2) = *(u16*)(mac);
#endif
	GSW_ARL_TABLE_ACCESS_CONTROL_1 = u.lookup_result;

	GSW_ARL_TABLE_ACCESS_CONTROL_0 = (0x1 << 2);

	do {
		u.lookup_result = GSW_ARL_TABLE_ACCESS_CONTROL_1;
		// still search, bit2 and bit0
	} while ((u.lookup_result & 0x5) == 0); 

	if (u.lookup_result & (0x1 << 2)) {
		return 1;
	} else {
		return 0; // not found
	}
	...
	for (i = 0; i < rxcount; i++) {
		...
		if (rxdesc_ptr->cown != 0) {
			...
			if (skb_ptr != NULL) {
				...
				PDEBUG("%s: Alloc sk_buff failed\n", __FUNCTION__);
				// Exit immediately, cown bit remains 1	
				return;
			}
		}
		else
		{
			PDEBUG("%s: Trying to release descriptor with cown=0\n", __FUNCTION__);
			return; // Probably FSSD was updated before cown bit. Do nothing and exit, next time we'll start with this descriptor
		}
...
static int __init star_gsw_proc_init(void)
{
		...
		star_phy_reset_proc_entry = create_proc_entry("phy_reset", S_IFREG | S_IRUGO, str9100_proc_dir);
        if (star_phy_reset_proc_entry) {
                star_phy_reset_proc_entry->write_proc = star_phy_reset_write_proc;
        }
        
        //Jacky.Yang 26-Aug-2009, Begin - Add command line for control port0~3.
        star_switch_port_enable_entry = create_proc_entry("switch_port_enable", S_IFREG | S_IRUGO, str9100_proc_dir);
        if (star_switch_port_enable_entry) {
       		//june.chen, 2011-01-03, add function star_switch_get_port_enable to get port status
		 star_switch_port_enable_entry->read_proc = star_switch_get_port_enable;
	         star_switch_port_enable_entry->write_proc = star_switch_set_port_enable;
        }
        
        star_switch_port_disable_entry = create_proc_entry("switch_port_disable", S_IFREG | S_IRUGO, str9100_proc_dir);
        if (star_switch_port_disable_entry) {
                star_switch_port_disable_entry->write_proc = star_switch_set_port_disable;
        }
        
        star_switch_port_link_status_entry = create_proc_entry("switch_get_port_link_status", S_IFREG | S_IRUGO, str9100_proc_dir);
        if (star_switch_port_link_status_entry) {
                star_switch_port_link_status_entry->read_proc = star_switch_get_port_link_status;
        }
        //Jacky.Yang 26-Aug-2009, End - Add command line for control port0~3.
...
// ED HW reset via gpio20 to Realtek switch
#ifdef CONFIG_GPB239M  
    	// Direction bit
	temp = GPIO_PIN_DIR_REG;
	temp |= (1 << GPIO_REALTEK_RESET);
	GPIO_PIN_DIR_REG = temp;
	// write '1' to Realtek reset 
	temp = GPIO_DATA_IN_REG;
	temp &= ~(1 <<GPIO_REALTEK_RESET);
	GPIO_DATA_OUT_REG = temp;
	temp |= (1 << GPIO_REALTEK_RESET);
	GPIO_DATA_OUT_REG = temp;
#endif
