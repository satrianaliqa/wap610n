 ...
 *
 ********************************************************************************/
#ifndef U_MEDIA_VELA_H
#define U_MEDIA_VELA_H

// add by descent 2006/07/07
#define U_MEDIA
#ifdef U_MEDIA
// init phy or switch chip
//Tim Wang, to support both RTL8201CP single PHY, or RTL8306SG
//We only use port 0 for WET610N/WAP610N/WES610N
#define INIT_PORT0_PHY rtl_init();
#define INIT_PORT1_PHY 

// configure mac0/mac1 register
//U-MEDIA, work around for RTL8201CP, skip this configuration.
#define INIT_PORT0_MAC
#define INIT_PORT1_MAC

//Tim Wang, to support both RTL8201CP single PHY, or RTL8306SG
#define PORT0_LINK_UP all_phy_power_down(0);
#define PORT0_LINK_DOWN all_phy_power_down(1);
...
#define PORT0_PHY_RESET
#define PORT1_PHY_RESET
