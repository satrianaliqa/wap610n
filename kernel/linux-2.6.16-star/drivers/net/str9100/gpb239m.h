...
// this configure is for star gpb239
// ED HW reset via gpio20 to Realtek switch
#define GPIO_REALTEK_RESET 		20
...
#define VLAN1_GROUP			(PORT0 | PORT1 | CPU_PORT)
...
/* ewc  */
static u8 my_vlan3_mac[6] = {0x00, 0xaa, 0xbb, 0xcc, 0xdd, 0x21};
