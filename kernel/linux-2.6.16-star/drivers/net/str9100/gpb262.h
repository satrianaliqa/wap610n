...
#define INIT_PORT0_PHY gpb262_phy_init();
#define INIT_PORT1_PHY

// configure mac0/mac1 register
#define INIT_PORT0_MAC gpb262_mac_init();
#define INIT_PORT1_MAC

#define PORT0_LINK_DOWN 
	//std_phy_power_down(0, 1);
#define PORT0_LINK_UP 
	//std_phy_power_down(0, 0);
...
// Declare board specific functions:
