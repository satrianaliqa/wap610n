...
#ifdef CONFIG_SPI_STR8131
#if defined(CONFIG_MTD_M25P80) || defined(CONFIG_MTD_M25P80_MODULE)
static struct str8131_spi_dev_attr str8131_spi_flash_attr = {
	.spi_serial_mode = STR8131_SPI_SERIAL_MODE_GENERAL,
};
...
static struct str8131_spi_dev_attr str8131_spi_le88221_attr = {
	.spi_serial_mode = STR8131_SPI_SERIAL_MODE_MICROPROCESSOR,
};
#endif
...
static struct spi_board_info str8131_spi_board_info[] = {
		...
		.controller_data = &str8131_spi_flash_attr,
        },
#endif
#if defined(CONFIG_LE88221_CONTROL)
	{
		...
		.bus_num	= 1,
		.platform_data	= NULL,
		.controller_data = &str8131_spi_le88221_attr,
        },
#endif
};
#endif
