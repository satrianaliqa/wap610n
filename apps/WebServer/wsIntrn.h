...
#define WEBS_SYM_INIT_521	521			/* initial # of sym table entries */
#define WEBS_SYM_INIT_1031  1031
#define WEBS_SYM_INIT_4099  4099
...
extern int 		 websCgiHandler(webs_t wp, char_t *urlPrefix, char_t *webDir,
					int arg, char_t *url, char_t *path, char_t *query);
extern int 		 websVirtualDirHandler(webs_t wp, char_t *urlPrefix, 
					char_t *webDir, int arg, char_t *url, char_t *path, 
					char_t *query);
...
extern int		 websStatisticsHandler(webs_t wp, char_t *urlPrefix, char_t *webDir, int arg,
									   char_t *url, char_t *path, char_t *query);
#endif // MT_USE_STAT_TASK
...
extern void websInitRealm(void); //Add for WET610N - Ricky Cao on 2008/09/03
