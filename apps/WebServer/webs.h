...
#define UPLOAD_FILE_TO_BIG  -1
#define UPLOAD_NO_MEMORY    -2
...
//extend the WEBS_BUFSIZE from 1000 to 38420 for HNAP - U-Media Ricky Cao on Jun. 16 2008
#define WEBS_BUFSIZE			76820		/* websWrite max output string */
...
#define WEBS_HNAP_FW_UPGRADE	  	0x01000000 //Add for HNAP firmware upgrade - Ricky Cao
...
#endif
	char_t*         FileContent;	    /* pointer to the start of the file data (upload file) */
	int             FileContentLen;	    /* length of file content */
} websRec;
...
#endif /* _h_WEBS */
int updateLinkStatusTag;

//Jacky.Yang 8-Mar-2009, Recorder WPS status
#define wpsArraySize 10
int wpsArrayIndex, wpsErrorCount;
int wpsStatusArray[wpsArraySize];
/******************************************************************************/
