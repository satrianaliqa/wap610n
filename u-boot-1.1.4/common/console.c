...
//june.chen, 2010-11-25, for disable console message
#ifdef CONFIG_UMEDIA_DISABLE_CONSOLE
#include <asm/arch-str9100/star_gpio.h>
int g_disable_console_flag;
#endif
//june.chen end
...
//june.chen, 2010-11-25, add for disable console message, if g_disable_console_flag = 1, disable it
#ifdef CONFIG_UMEDIA_DISABLE_CONSOLE
...
//june.chen, 2010-11-25, to check if WPS button is pressed. If yes, set disable console flag=1
#ifdef CONFIG_UMEDIA_DISABLE_CONSOLE
	uint gpio_data;
	gpio_data = gpio_data = GPIO_GPIO_DATA_IN_REG;
//	printf("\n\n\n\n\ngpio_data = %x\n\n\n\n\n", gpio_data);
	if((gpio_data & (1 << 13)) == 0){ //june.chen, test if WPS button is pressed
		g_disable_console_flag = 0;
	}
	else{
		g_disable_console_flag = 1;
	}
#endif
//june.chen end
	return (0);
