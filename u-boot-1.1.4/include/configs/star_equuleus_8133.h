...
#define	CONFIG_STR8131		1	/* in a STR8131 SoC */
#define	CONFIG_STR8133		1	/* STAR 8133 demo board */
...
#define CONFIG_COMMANDS (CONFIG_CMD_DFL | CFG_CMD_PCI | CFG_CMD_I2C | CFG_CMD_PING)
