...
static inline str8131_cpu_enter_idle_mode(void)
{
	u32 zero = 0;
	__asm__ __volatile__("mcr	p15, 0, %0, c7, c0, 4" : : "r" (zero) : "cc");
}

static void str8131_adjust_dram_auto_refresh_interval(u32 old_ahb_clock, u32 new_ahb_clock)
{
...
static u32 str8131_ahb_clock(void)
{
	u32 PLL_clock;
	u32 CPU_clock;
	u32 AHB_clock;
...
void str8131_cpu_clock_show(void)
{
	u32 PLL_clock;
	u32 CPU_clock;
	u32 AHB_clock;
...
void str8131_cpu_clock_scale_start(void)
{
	u32 timer_control;
	u32 status;
	u32 last_time;
