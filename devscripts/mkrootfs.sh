...
ROOTFS_DIR=/opt/rootfs-star
IMAGE_DIR=/opt/star/images
...
cd $ROOTFS_DIR 
echo -n SVN Revision `svnversion .` "  " > etc/version
...
/opt/devscripts/umount-rd.sh -n 1
