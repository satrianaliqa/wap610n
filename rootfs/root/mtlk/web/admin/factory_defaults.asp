...
function restoreToAP() {
	document.getElementById("restoreTag").value = "AP";
	/*totalWaitTime = 10; //second
	wait_page();
		document.getElementById("waitPad").style.display="block";*/
	//resetToDefault.submit();
	//Jacky.Yang 13-Dec-2007 - waitting page and redirect url
	/*if (mode == 0) //STA mode
	{
		totalWaitTime = 70; //second
		redirectURL = "http://" + "192.168.1.227" + "/basic/mode.asp";
	}
	else if (mode == 2) //AP mode
	{
		totalWaitTime = 70; //second
		redirectURL = "http://" + "192.168.1.226" + "/basic/mode.asp";
	}
	reboot_page();*/
	document.resetToDefault.submit();
}

function restoreToSTA() {
	if (confirm("<!--#tr id=\"adm.fd.confirm.1\" -->Warning! If you click OK, the device will reset to factory default and all previous settings will be erased.<!--#endtr-->")){
		document.getElementById("restoreTag").value = "STA";
...
<table border="0" width="809" cellpadding="0" cellspacing="0" align="center"><tr><td>
						...
						<td class="subMenu">
							<table>
								<tr>
									...
									<td class="subMenuOption"><!--#tr id="adm.submenu.2" -->Factory Defaults<!--#endtr--></td>
									<td class="subMenuDIV">|</td>
	...
	<form method="post" name="resetToDefault" action="/goform/resetToDefault">
		<tr>
			<td class="noSPACE">
				<input type="hidden" id="restoreTag" name="restoreTag" value="">
				<table class="mainTableContent" cellspacing="0">
					<tr>
						<td class="subMenuMainContent" colspan="2"><!--#tr id="adm.fd.title" -->Factory Defaults<!--#endtr--></td>
				...
				<table id="mainform" class="mainTableContent" cellspacing="0">
					...
					<tr>
						...
						<td class="blankContent" colspan="2">
							<input type="button" value="<!--#tr id=\"adm.fd.1\" -->Restore All Settings<!--#endtr-->" onclick="restoreToSTA();">
						</td>
					</tr>
				</table>
				<table class="mainTableContent" cellspacing="0">
				...
				<table class="mainTableContent" cellspacing="0">
					...
					<tr>
						...
						<td class="footContent" colspan="2">
							<div id="saveField">
							<!--<a class="bottonClass" href="javascript:checkValue()">Save Settings</a>
