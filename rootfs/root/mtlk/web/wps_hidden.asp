...
<table border="0" width="809" cellpadding="0" cellspacing="0" align="center"><tr><td>
		...
		<tr>
			<td colspan="2" class="noSPACE" cellspacing="0">
				...
				<table>
					<tr>
						<!--Total width=645-->
						<td width="129" class="mainMenuSelectedUpSide"></td>
						<td width="129" class="mainMenuOptionUpSide"></td>
						<td width="129" class="mainMenuOptionUpSide"></td>
						<td width="129" class="mainMenuOptionUpSide"></td>
						<td width="129" class="mainMenuOptionUpSide"></td>
					</tr>
					<tr>
						<td width="129" class="mainMenuSelected"><a href="basic/mode.asp">Setup</a></td>
						<td width="129" class="mainMenuOption"><a id="ap_wbridge" href="">Wireless</a></td>
						<td width="129" class="mainMenuOption"><a href="advanced/advanced_wireless.asp">Advanced</a></td>
						<td width="129" class="mainMenuOption"><a href="admin/management.asp">Administration</a></td>
						<td width="129" class="mainMenuOption"><a href="status/device_status.asp">Status</a></td>
					</tr>
				</table>
				<!-- InstanceEndEditable -->
		  </td>
						...
						<td class="subMenu">
							<table>
								<tr>
									...
									<td class="subMenuOption">Basic</td>
									<td class="subMenuDIV">|</td>
									<td class="subMenuOption"><font class="small"><a href="/basic/network.asp">Network Setup</a></font></td>
									<!-- InstanceEndEditable -->
								</tr>
							</table>
						</td>
	...
	<form method="post" name="" action="/goform/wpsTest">
		BSSID_USAGE_IN_CONNECTION_POLICY: <input type="text" id="WPS_BSSID_USAGE" name="WPS_BSSID_USAGE" value="<% getParam(1, "WPS_BSSID_USAGE"); %>">
