...
function page_load() {
	...
	{
		//alert("wireless_basic.asp");
		connecting_wait_page();
	}
	else
	{
		//alert("non wireless_basic.asp");
		process_page();
	}
		...
		<tr>
			<td colspan="2" class="noSPACE" cellspacing="0">
				...
				<table>
					...
					<tr>
						<td width="172" class="mainMenuOption"><a href="basic/network.asp"><!--#tr id="mainmenu.2" -->Setup<!--#endtr--></a></td>
		...
		<tr>
			<td class="noSPACE">
				<table class="mainTableContent" cellspacing="0">
					<tr>
						<td class="subMenuMainContent" colspan="2"><!--#tr id="adm.waitpage.1" -->Processing<!--#endtr--></td>
