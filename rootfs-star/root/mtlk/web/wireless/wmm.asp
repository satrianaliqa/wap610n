...
*/		
	...
	{
		document.getElementById("modelNameDisplay").innerHTML = "WAP610N"; document.getElementById("descriptionDisplay").innerHTML = "Dual-Band Wireless-N Access Point"; document.getElementById("descriptionDisplay").innerHTML = "Dual-Band Wireless-N Access Point";
						...
						<td class="subMenu">
							<table>
								<tr>
									...
									<td class="subMenuDIV">|</td>
									<td class="subMenuOption"><font class="small"><!--#tr id="w.submenu.3" -->WMM®<!--#endtr--></font></td>
									<td class="subMenuDIV">|</td>
