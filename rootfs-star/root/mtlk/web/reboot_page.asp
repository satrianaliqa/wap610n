...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US" xml:lang="en-US"><!-- InstanceBegin template="/Templates/reboot.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
						...
						<td class="subMenu">
							<table>
								<tr>
									...
									<td class="subMenuOption"><font class="small"><a href=""><!--#tr id="adm.submenu.1" -->Management<!--#endtr--></a></font></td>
									<td class="subMenuDIV">|</td>
									<td class="subMenuOption"><font class="small"><a href=""><!--#tr id="adm.submenu.2" -->Factory Defaults<!--#endtr--></a></font></td>
									<td class="subMenuDIV">|</td>
									<td class="subMenuOption"><font class="small"><a href=""><!--#tr id="adm.submenu.3" -->Firmware Upgrade<!--#endtr--></a></font></td>
									<!-- InstanceEndEditable -->
								</tr>
							</table>
						</td>
		...
		<tr>
			<td class="noSPACE">
				<table class="mainTableContent" cellspacing="0">
					<tr>
						<td class="subMenuMainContent" colspan="2"><!--#tr id="adm.man.4" -->System Reboot<!--#endtr--></td>
